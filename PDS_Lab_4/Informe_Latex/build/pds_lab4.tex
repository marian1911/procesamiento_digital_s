...
\begin{document}
	...
	\section{Análisis de la influencia del ruido}
		...
		\subsection{Resultados Experimentales}
			...
			Para evaluar el firmware implementado en la placa STM32, se inyectó una señal senoidal de
			3,3 Vpp con una tensión de offset de 1,65 V. El ensayo se realizó para dos frecuencias de
			entrada, 100 Hz y 1 kHz, con el objetivo de comparar la respuesta del sistema ante distintas
			condiciones de operación.

			En la Figura~\ref{fig:Sal_100Hz} se muestra la comparación para una señal de entrada de
			100 Hz. La señal contaminada se observa en amarillo, mientras que la señal de salida limpia
			se representa en celeste.

			\begin{figure}[H]
				\centering
				\includegraphics[width=0.7\textwidth]{imagenes/Sal_in100hz_3Vpp_offset1_5V.jpeg}
				\caption{Salida limpia para señal de entrada de 100 Hz.}
				\label{fig:Sal_100Hz}
			\end{figure}

			En la Figura~\ref{fig:Sal_1000Hz} se presenta el mismo ensayo para una frecuencia de entrada
			de 1 kHz. Nuevamente, la señal contaminada corresponde al trazo amarillo, mientras que
			la salida limpia corresponde al trazo celeste.

			\begin{figure}[H]
				\centering
				\includegraphics[width=0.7\textwidth]{imagenes/Sal_in1000hz_3Vpp_offset1_5V.jpeg}
				\caption{Salida limpia para señal de entrada de 1 kHz.}
				\label{fig:Sal_1000Hz}
			\end{figure}
