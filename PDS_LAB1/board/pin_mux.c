...
- {pin_num: '18', pin_signal: ADC0_DP0/ADC1_DP3, label: 'J2[5]', identifier: ADC_Channel_0}
...
- {pin_num: '38', pin_signal: PTA4/LLWU_P3/FTM0_CH1/NMI_b/EZP_CS_b, label: Frec_Change, identifier: SW3}
- {pin_num: '78', pin_signal: CMP0_IN0/PTC6/LLWU_P10/SPI0_SOUT/PDB0_EXTRG/I2S0_RX_BCLK/FB_AD9/I2S0_MCLK, label: Run_Stop_button, identifier: SW2;ACCEL_INT1}
