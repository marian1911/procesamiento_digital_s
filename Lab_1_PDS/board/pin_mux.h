...
#define BOARD_LED_B_GPIO_PIN_MASK (1U << 0U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_LED_B_PORT PORTC               /*!<@brief PORT peripheral base pointer */
#define BOARD_LED_B_PIN 0U                   /*!<@brief PORT pin number */
#define BOARD_LED_B_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                             /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_LED_V_GPIO GPIOC               /*!<@brief GPIO peripheral base pointer */
#define BOARD_LED_V_GPIO_PIN_MASK (1U << 1U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_LED_V_PORT PORTC               /*!<@brief PORT peripheral base pointer */
#define BOARD_LED_V_PIN 1U                   /*!<@brief PORT pin number */
#define BOARD_LED_V_PIN_MASK (1U << 1U)      /*!<@brief PORT pin mask */
                                             /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_LED_A_GPIO GPIOC               /*!<@brief GPIO peripheral base pointer */
#define BOARD_LED_A_GPIO_PIN_MASK (1U << 2U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_LED_A_PORT PORTC               /*!<@brief PORT peripheral base pointer */
#define BOARD_LED_A_PIN 2U                   /*!<@brief PORT pin number */
#define BOARD_LED_A_PIN_MASK (1U << 2U)      /*!<@brief PORT pin mask */
                                             /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_LED_N_GPIO GPIOC               /*!<@brief GPIO peripheral base pointer */
#define BOARD_LED_N_GPIO_PIN_MASK (1U << 4U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_LED_N_PORT PORTC               /*!<@brief PORT peripheral base pointer */
#define BOARD_LED_N_PIN 4U                   /*!<@brief PORT pin number */
#define BOARD_LED_N_PIN_MASK (1U << 4U)      /*!<@brief PORT pin mask */
                                             /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_Frenc_changer_GPIO GPIOA               /*!<@brief GPIO peripheral base pointer */
#define BOARD_Frenc_changer_GPIO_PIN_MASK (1U << 4U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_Frenc_changer_PORT PORTA               /*!<@brief PORT peripheral base pointer */
#define BOARD_Frenc_changer_PIN 4U                   /*!<@brief PORT pin number */
#define BOARD_Frenc_changer_PIN_MASK (1U << 4U)      /*!<@brief PORT pin mask */
                                                     /* @} */
