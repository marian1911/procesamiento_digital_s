...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{16k.png}
		\caption[Medición a 16 kHz]{Medición de la señal a frecuencia de muestreo de 16 kHz}
		\label{fig:16k}
	\end{figure}

	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{24k.png}
		\caption[Medición a 24 kHz]{Medición de la señal a frecuencia de muestreo de 24 kHz}
		\label{fig:24k}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{40k.png}
		\caption[Medición a 40 kHz]{Medición de la señal a frecuencia de muestreo de 40 kHz}
		\label{fig:40k}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{48k.png}
		\caption[Medición a 48 kHz]{Medición de la señal a frecuencia de muestreo de 48 kHz}
		\label{fig:48k}
	\end{figure}
