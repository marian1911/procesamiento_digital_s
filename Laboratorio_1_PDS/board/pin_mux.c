...
- {pin_num: '72', pin_signal: ADC0_SE4b/CMP1_IN0/PTC2/SPI0_PCS2/UART1_CTS_b/FTM0_CH1/FB_AD12/I2S0_TX_FS, label: 'J1[14]', identifier: ts_32k;ts_22k}
- {pin_num: '73', pin_signal: CMP1_IN1/PTC3/LLWU_P7/SPI0_PCS1/UART1_RX/FTM0_CH2/CLKOUT/I2S0_TX_BCLK, label: 'J1[16]', identifier: ts_44k}
...
- {pin_num: '71', pin_signal: ADC0_SE15/PTC1/LLWU_P6/SPI0_PCS3/UART1_RTS_b/FTM0_CH0/FB_AD13/I2S0_TXD0, label: 'J1[5]', identifier: ts_16k}
...
- {pin_num: '70', pin_signal: ADC0_SE14/PTC0/SPI0_PCS4/PDB0_EXTRG/USB_SOF_OUT/FB_AD14/I2S0_TXD1, label: 'J1[11]', identifier: ts_8k}
- {pin_num: '84', pin_signal: PTC12/UART4_RTS_b/FB_AD27/FTM3_FLT0, label: 'J2[2]'}
- {pin_num: '76', pin_signal: PTC4/LLWU_P8/SPI0_PCS0/UART1_TX/FTM0_CH3/FB_AD11/CMP1_OUT, label: 'J2[4]', identifier: ts_48k}
...
- {pin_num: '38', pin_signal: PTA4/LLWU_P3/FTM0_CH1/NMI_b/EZP_CS_b, label: SW3, identifier: SW3;Sample_Time}
- {pin_num: '78', pin_signal: CMP0_IN0/PTC6/LLWU_P10/SPI0_SOUT/PDB0_EXTRG/I2S0_RX_BCLK/FB_AD9/I2S0_MCLK, label: 'U8[11]/SW2', identifier: SW2;ACCEL_INT1;Start;Start_Stop}
...
- pin_list:
  ...
  - {pin_num: '78', peripheral: GPIOC, signal: 'GPIO, 6', pin_signal: CMP0_IN0/PTC6/LLWU_P10/SPI0_SOUT/PDB0_EXTRG/I2S0_RX_BCLK/FB_AD9/I2S0_MCLK, identifier: Start_Stop,
    direction: INPUT, gpio_interrupt: kPORT_InterruptRisingEdge, slew_rate: slow, drive_strength: high, pull_enable: enable}
  - {pin_num: '38', peripheral: GPIOA, signal: 'GPIO, 4', pin_signal: PTA4/LLWU_P3/FTM0_CH1/NMI_b/EZP_CS_b, identifier: Sample_Time, direction: INPUT, gpio_interrupt: kPORT_InterruptRisingEdge,
    slew_rate: slow, drive_strength: high, pull_select: down}
  - {pin_num: '70', peripheral: GPIOC, signal: 'GPIO, 0', pin_signal: ADC0_SE14/PTC0/SPI0_PCS4/PDB0_EXTRG/USB_SOF_OUT/FB_AD14/I2S0_TXD1, direction: OUTPUT, gpio_init_state: 'false',
    slew_rate: slow, drive_strength: high, pull_enable: enable}
  - {pin_num: '71', peripheral: GPIOC, signal: 'GPIO, 1', pin_signal: ADC0_SE15/PTC1/LLWU_P6/SPI0_PCS3/UART1_RTS_b/FTM0_CH0/FB_AD13/I2S0_TXD0, direction: OUTPUT,
    gpio_init_state: 'false', slew_rate: slow, drive_strength: high, pull_enable: enable}
  - {pin_num: '72', peripheral: GPIOC, signal: 'GPIO, 2', pin_signal: ADC0_SE4b/CMP1_IN0/PTC2/SPI0_PCS2/UART1_CTS_b/FTM0_CH1/FB_AD12/I2S0_TX_FS, identifier: ts_22k,
    direction: OUTPUT, slew_rate: slow, drive_strength: high, pull_enable: enable}
  - {pin_num: '73', peripheral: GPIOC, signal: 'GPIO, 3', pin_signal: CMP1_IN1/PTC3/LLWU_P7/SPI0_PCS1/UART1_RX/FTM0_CH2/CLKOUT/I2S0_TX_BCLK, direction: OUTPUT, slew_rate: slow,
    drive_strength: high, pull_enable: enable}
  - {pin_num: '76', peripheral: GPIOC, signal: 'GPIO, 4', pin_signal: PTC4/LLWU_P8/SPI0_PCS0/UART1_TX/FTM0_CH3/FB_AD11/CMP1_OUT, direction: OUTPUT, slew_rate: slow,
    drive_strength: high, pull_enable: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t Sample_Time_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTA4 (pin 38)  */
    GPIO_PinInit(BOARD_Sample_Time_GPIO, BOARD_Sample_Time_PIN, &Sample_Time_config);

    gpio_pin_config_t ts_8k_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC0 (pin 70)  */
    GPIO_PinInit(BOARD_ts_8k_GPIO, BOARD_ts_8k_PIN, &ts_8k_config);

    gpio_pin_config_t ts_16k_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC1 (pin 71)  */
    GPIO_PinInit(BOARD_ts_16k_GPIO, BOARD_ts_16k_PIN, &ts_16k_config);

    gpio_pin_config_t ts_22k_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC2 (pin 72)  */
    GPIO_PinInit(BOARD_ts_22k_GPIO, BOARD_ts_22k_PIN, &ts_22k_config);

    gpio_pin_config_t ts_44k_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC3 (pin 73)  */
    GPIO_PinInit(BOARD_ts_44k_GPIO, BOARD_ts_44k_PIN, &ts_44k_config);

    gpio_pin_config_t ts_48k_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC4 (pin 76)  */
    GPIO_PinInit(BOARD_ts_48k_GPIO, BOARD_ts_48k_PIN, &ts_48k_config);
    ...
    GPIO_PinInit(BOARD_Start_Stop_GPIO, BOARD_Start_Stop_PIN, &Start_Stop_config);
    ...
    PORT_SetPinMux(BOARD_Sample_Time_PORT, BOARD_Sample_Time_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTA4 (pin 38): Interrupt on rising edge */
    PORT_SetPinInterruptConfig(BOARD_Sample_Time_PORT, BOARD_Sample_Time_PIN, kPORT_InterruptRisingEdge);

    PORTA->PCR[4] = ((PORTA->PCR[4] &
                      /* Mask bits to zero which are setting */
                      (~(PORT_PCR_PS_MASK | PORT_PCR_SRE_MASK | PORT_PCR_DSE_MASK | PORT_PCR_ISF_MASK)))
    ...
    PORT_SetPinMux(BOARD_ts_8k_PORT, BOARD_ts_8k_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_ts_16k_PORT, BOARD_ts_16k_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_ts_22k_PORT, BOARD_ts_22k_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_ts_44k_PORT, BOARD_ts_44k_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_ts_48k_PORT, BOARD_ts_48k_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_Start_Stop_PORT, BOARD_Start_Stop_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTC6 (pin 78): Interrupt on rising edge */
    PORT_SetPinInterruptConfig(BOARD_Start_Stop_PORT, BOARD_Start_Stop_PIN, kPORT_InterruptRisingEdge);
